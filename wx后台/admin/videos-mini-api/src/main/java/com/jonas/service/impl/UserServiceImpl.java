...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PagedResult getUserInfoByCondition(UserDTO userDTO) {
        ...
        List<UserInfo> userInfoByCondition = userInfoMapper.getUserInfoByCondition(userDTO.getUserInfo());
        PageInfo<UserInfo> videoVOList = new PageInfo<>(userInfoByCondition);
